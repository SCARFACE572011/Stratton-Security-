    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ fontSize: "12px", color: "#c49a2a", letterSpacing: "0.2em", textTransform: "uppercase" }}>NOW HIRING — LOS ANGELES</div>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ fontSize: "11px", color: "#4a6880", letterSpacing: "0.08em", textTransform: "uppercase" }}>CA Guard Card Required · BSIS Licensed Officers</span>
          <span style={{ fontSize: "12px", color: "#7a9ab8" }}>strattonsecuritygroup.com/careers</span>
        </div>
