    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ fontSize: "12px", color: "#c49a2a", letterSpacing: "0.2em", textTransform: "uppercase" }}>COMMON QUESTIONS ANSWERED</div>
          ...
          <div style={{ fontSize: "18px", color: "#9fb5cb", lineHeight: 1.5, maxWidth: "640px", marginTop: "8px" }}>
            Licensing, service areas, armed vs. unarmed, deployment timelines, officer training, and more.
          </div>
        </div>

        {/* Topic tags */}
        <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
          {["Licensing & Compliance", "Service Areas", "Armed vs. Unarmed", "Response Times", "Pricing"].map((p) => (
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ fontSize: "11px", color: "#4a6880", letterSpacing: "0.08em", textTransform: "uppercase" }}>BSIS Licensed · PPO Certified · Los Angeles</span>
          <span style={{ fontSize: "12px", color: "#7a9ab8" }}>strattonsecuritygroup.com/faq</span>
        </div>
