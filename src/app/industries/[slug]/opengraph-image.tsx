...
export default async function OGImage({
  ...
  const title = industry?.label ?? "Industry Security";
  const description = industry?.summary ?? "Professional security services tailored to your industry across Los Angeles.";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ fontSize: "12px", color: "#c49a2a", letterSpacing: "0.2em", textTransform: "uppercase" }}>INDUSTRY VERTICAL</div>
